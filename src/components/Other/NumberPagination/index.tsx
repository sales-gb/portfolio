    ...
    <>
      {router.pathname === "/about" && (
        <div className="flex items-center justify-center z-50 ">
          <p
            className={`absolute h-8 text-center lg:text-start top-4 text-brand8 whitespace-nowrap uppercase leading-tight z-50 left-8 sm:left-12 lg:left-20 text-2xl sm:text-3xl lg:text-4xl after:content-[''] after:bg-brand4 after:absolute after:m-auto after:h-1 after:bottom-4 sm:after:bottom-3 lg:after:bottom-2 after:translate-x-2/4 after:w-[50vw] after:-left-[75.5vw] ${abril.className}`}
          >{`0${number}`}</p>
